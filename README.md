...
Indexer: collect and index content into a Bibliotalk archive
- Blog/Archive Website
- RSS
- YouTube Channel / List
- EBook (EPUB/PDF/MD/TXT) - only in public domain
  - Only keep essays, letters, diaries, talks, discourses, etc.
  - No fiction writings: novels, plays, etc.
  - Hard to handle dialogues/conversations! Chunk by Q&A? Must distinguish speakers.

Retriever: text+vector search
